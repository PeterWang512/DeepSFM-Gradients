...
parser.add_argument("--dataset_name", type=str, required=True, choices=["kitti_raw_eigen", "kitti_edge", "kitti_raw_stereo", "kitti_odom", "cityscapes"])
...
def main():
    ...
    if args.dataset_name == "kitti_edge":
        import kitti.kitti_edge_loader as edge_ldr
        data_loader = edge_ldr.kitti_edge_loader(args.dataset_dir,
                                                 split='eigen',
                                                 img_height=args.img_height,
                                                 img_width=args.img_width,
                                                 seq_length=args.seq_length)
    ...
    for n in range(33000, data_loader.num_train):
        dump_example(n)
