...
class DataLoader(object):
    ...
    def load_train_batch(self):
        ...
        tgt_image, src_image_stack, edge_image = \
        ...
        src_image_stack, tgt_image, edge_image, intrinsics = \
                tf.train.batch([src_image_stack, tgt_image, edge_image, intrinsics], 
        ...
        return tgt_image, src_image_stack, intrinsics, edge_image
    ...
    def unpack_image_sequence(self, image_seq, img_height, img_width, num_source):
        ...
        src_image_2 = tf.slice(image_seq, 
                               [0, int(tgt_start_idx + 2*img_width), 0], 
                               [-1, int(img_width * (num_source//2)), -1])
        # edge image
        edge_image = tf.slice(image_seq, 
        ...
        edge_image.set_shape([img_height, img_width, 1])
        return tgt_image, src_image_stack, edge_image
    ...
    def batch_unpack_image_sequence(self, image_seq, img_height, img_width, num_source):
        ...
        # Source frames after the target frame
        src_image_2 = tf.slice(image_seq, 
                               [0, 0, int(tgt_start_idx + 2*img_width), 0], 
                               [-1, -1, int(img_width * (num_source//2)), -1])
